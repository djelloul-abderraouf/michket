...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez les dernières nouveautés Michket : lampes 3D, trophées, néons LED et nouvelles créations personnalisables.",
};
